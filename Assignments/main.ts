...
// Task no 11
let names:string [] = ["Abbas","Ali","Hamza","Husnain"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
// Task no 13
let tranportations:string []=["Honda","Audi","Honda city"];
tranportations.map((items) => console.log(`I would like to own a ${items}`));

// Task no 14
let guestArr:string [] = ["Abbas","Ali","Hamza","Husnain"];
...
let message1:string = "I found a bigger dinner table so I invite more peoples";
guestArr.map((items) => (console.log(`Dear ${items} , ${message1}`)));

// Part 2
let guestBeg:string="Salman";
guestArr.unshift(guestBeg);
console.log(guestArr);

// Part 3
let guestMid:string="Naveed";
let indexMid:number=guestArr.length/2
guestArr.splice(indexMid,0,guestMid)
console.log(guestArr);

// Part 4
let guestEnd:string="Iqbal";
guestArr.push(guestEnd);
console.log(guestArr);


// Part 5
let message2:string="You are invited to the dinner";
...
let places:string[] = ["MADINA E MUNAWWARAH","MAKKA E MUKARRAMA","SHAM","EGYPT","AFGHANISTAN"];
...
let guestArr : string [] = ["Abbas","Ali"];
let count_guests : number = guestArr.length;
...
let languages:string[]=["Arabic","Urdu","Persian","Hebrew"]
...
let person:
{name:string,fname:string,age:number}=
{name:"M.Abbas",fname:"M.Assad",age:21};

console.log(person);

// Task no 22

let items:string[]=["pencil","watch","cap"];
// console.log(items[6]); It's an index error
console.log(items[2]);

// Task no 23

let sweet:string="bisconni";
...
let person_1: string = "abbas";
let person_2: string = "abbas bhai";
let person_3: string = "Abbas";

let a: number = 24;
let b: number = 30;
let c: number = 18;

let vegetables: string [] = ["potato","onion","brinjal","carrot"];
...
let favourite_fruits:string [] =["Banana", "Apple", "Watermelon"];
...
let username:string [] =["admin","abbas","assad","abdulhaseeb","jawed"];
...
let current_users:string [] =["abbas","assad","abdulhaseeb","jawed","aslam"];

let new_users:string []=["asghar","abdulhaseeb","waris","iqbal","abbas"];
...
let pizza_flavours:string[]=["Cheese Pizza","BBQ Chicken Pizza","Chicken Fajita"];
...
let same_ch_animals:string[]=["Camel","Cow","Goat"];
...
let cc1: string = city_country('Lahore', 'Pakistan');
let cc2: string = city_country('Tashkent','Uzbekistan');
let cc3: string = city_country('Delhi','Hind');
...
let  magicians:string[]=['Jessica Williams','Christopher Brown','Ashley Martinez','Joshua Lee','Matthew Nguye'];
...
function make_great(arr: string[], prefix: string): void {
...
let magicians: string[] = [
  ...
  function make_great(arr: string[], prefix: string): string[] {
    let new_arr: string[] = []; // Create a new array to store modified names
    for (let i = 0; i < arr.length; i++) {
  ...
  let great_magicians: string[] = make_great(magicians_copy, " the Great");
