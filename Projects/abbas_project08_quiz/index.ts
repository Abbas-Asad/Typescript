...
let answer4 = await inquirer.prompt([
    {
        ...
        type: "list",
        message:
            "Which file is used to configure TypeScript options for a project?",
...
let answer6 = await inquirer.prompt([
    {
        ...
        type: "list",
        message:
            "What is the default visibility modifier for class members in TypeScript?",
...
let answer9 = await inquirer.prompt([
    {
        ...
        type: "list",
        message:
            "Which operator is used for optional properties in TypeScript interfaces?",
        choices: ["/", "?", "*", "!"],
    },
]);
...
let answer10 = await inquirer.prompt([
    {
        ...
        type: "list",
        message:
            "Which TypeScript feature allows you to reuse code across multiple projects?",
